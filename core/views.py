...
def home(request):
    if request.method == "POST":
        ...
        if nombre and email and whatsapp and servicio and mensaje:
            servicio_legible = dict(Lead.SERVICIOS).get(servicio, "")
            ...
            messages.error(
                request,
                "Faltan completar campos obligatorios (nombre, email, WhatsApp, servicio y mensaje).",
            )
